...
class Transformer(nn.Module):
    ...
    NOTE: start token is hard-coded to be 0, end token to be 1.
    If changing, update predict() accordingly.
    """
    ...
    def predict(self, x: torch.Tensor) -> torch.Tensor:
        ...
        This method is greedy decoding, consider using Beam search to boost accuracy.
